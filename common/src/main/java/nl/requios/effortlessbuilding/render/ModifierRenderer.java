...
public class ModifierRenderer {
    ...
    public static void render(PoseStack poseStack, SubmitNodeCollector submitNodeCollector,
        ...
        for (IModifier modifier : ModifierSystem.CLIENT.getModifiers()) {
            ...
            if (modifier instanceof MirrorModifier mirror) {
                renderMirrorPlanes(poseStack, submitNodeCollector, mirror, camX, camY, camZ);
            } else if (modifier instanceof RadialMirrorModifier radial) {
                renderRadialBoundary(poseStack, submitNodeCollector, radial, camX, camY, camZ);
            }
        }
    ...
    private static void renderMirrorPlanes(PoseStack poseStack, SubmitNodeCollector submitNodeCollector,
    ...
    private static void renderRadialBoundary(PoseStack poseStack, SubmitNodeCollector submitNodeCollector,
